...
public class TransportListener {
    ...
    public TransportListener(int dataServerPort) throws IOException, JSONException {
        ...
        switch (dataServerPort) {
            case 1111:
                sendDataUdp(mavenLocation, "{\"employee\":{\"firstName\":\"Victor\",\"lastName\":\"Rotaru\",\"department\":\"Tehnic\",\"salary\":504}}");
                System.out.println("[INFO] -----------------------------------------\n" +
                        "[INFO] Data was sent to Maven");
                break;
            case 2222:
                sendDataUdp(mavenLocation, "{\"employee\":{\"firstName\":\"Eugenia\",\"lastName\":\"Blanaru\",\"department\":\"Vinzari\",\"salary\":501}}");
                System.out.println("[INFO] -----------------------------------------\n" +
                        "[INFO] Data was sent to Maven");
                break;
            case 3333:
                ...
                break;
            case 4444:
                sendDataUdp(mavenLocation, "{\"employee\":{\"firstName\":\"Gigi\",\"lastName\":\"Iures\",\"department\":\"Marketing\",\"salary\":502}}");
                System.out.println("[INFO] -----------------------------------------\n" +
                        "[INFO] Data was sent to Maven");
                break;
            case 5555:
                sendDataUdp(mavenLocation, "{\"employee\":{\"firstName\":\"Igor\",\"lastName\":\"Ignat\",\"department\":\"Financiar\",\"salary\":503}}");
                System.out.println("[INFO] -----------------------------------------\n" +
                        "[INFO] Data was sent to Maven");
                break;
            case 6666:
